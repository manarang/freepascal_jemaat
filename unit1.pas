...
begin
  ...
  then
    begin
      ...
      pdf.SetXY(10,10);
      pdf.Cell(190,8,'Daftar Jemaat keseluruhan','1',0,'C',0);
      ...
      PdfY:= 18;
      ct:= 0;
      while ct<Form1.count do
       begin
          ct:= ct +1;
          PdfY := PdfY + 7;
          pdf.SetXY(10,PdfY);
          pdf.Cell(55,7,Form1.SG.Cells[2,ct],'1',0,'L',0);
          pdf.SetX(65);
          pdf.Cell(70,7,Form1.SG.Cells[3,ct],'1',0,'L',0);
          pdf.SetX(135);
          pdf.Cell(30,7,Form1.SG.Cells[9,ct],'1',0,'L',0);
          pdf.SetX(165);
          pdf.Cell(35,7,Form1.SG.Cells[4,ct] ,'1',0,'L',0);
          if(PdfY >=255) then
          begin
            pdf.AddPage();
            pdf.SetFont(ffHelvetica,fsBold,14);
